...
public class EglProgramYVYU extends EglProgramYUV {

    private final int offsetLoc;

    public EglProgramYVYU(EglBufferObjectHolder eglBOHolder) {
        super(FRAGMENT_SHADER_RGB_TO_YVYU, eglBOHolder);
    ...
    public FrameFormat getFrameFormat() {
        return FrameFormat.YVYU;
    }

    private static final String FRAGMENT_SHADER_RGB_TO_YVYU = "" +
            "#version 300 es\n" +
