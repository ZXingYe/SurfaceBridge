...
public class EglProgramYUVY extends EglProgramYUV {

    private final int offsetLoc;

    public EglProgramYUVY(EglBufferObjectHolder eglBOHolder) {
        super(FRAGMENT_SHADER_RGB_TO_YUVY, eglBOHolder);
    ...
    public FrameFormat getFrameFormat() {
        return FrameFormat.YUVY;
    }

    private static final String FRAGMENT_SHADER_RGB_TO_YUVY = "" +
            "#version 300 es\n" +
